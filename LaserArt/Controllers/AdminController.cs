...
namespace LaserArt.Controllers
{
    public class AdminController : Controller
    {
        ...
        {
            Video video = Models.Video.GetVideos(id).FirstOrDefault();
            return View("CreateVideo", video);
        }
        ...
        [HttpPost]
        [Authorize(Roles = "Administrator")]
        public ActionResult CreateVideo(Video newCategory)
        {
            try
            {
                newCategory.Save();
            ...
            {
                return View("CreateVideo",newCategory);
            }
        }
        [HttpPost]
        [Authorize(Roles = "Administrator")]
